...
<?php
...

    {
...

        {
...

            {
...

                {
                    ...
                    echo '<div class="p-vocblock" style="width: 230px;" onclick="PlayOrStopSound(this)" ';
...

                {
                    ...
                    echo '<div class="p-vocblock" style="width: 180px;" onclick="PlayOrStopSound(this)" ';
                ...
                echo '<h3 style="font-size: 1.5em;">'.$ele->{'word'}.'</h3>';
...

        {
            ...
            echo '<h2>選出 <font style="font-size:1.6em;">"'.$ele->{'word'}.'"</font> 的正確讀音</h2>';
